...
public class Stato {
	...
	private Stato(Scacchiera s, byte g, boolean m){
	 ...
	 */
	public Stato(Scacchiera s, byte g){
		this(s,g,false);
	}
	 ...
	 */
	public Stato muovi(Mossa m){
		Stato s=m.tris() ? new Stato((Scacchiera)this.s.clone(),g,true) : new Stato((Scacchiera)this.s.clone(),Casella.altroColore(g),false);
		m.apply(s.s);
		lm=null;
		return s;
	}
