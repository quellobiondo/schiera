...
public class Stato implements Serializable, Comparable<Stato> {
    ...
    protected List<Mossa> movesHistory = new ArrayList<> ();
    ...
    public int evaluate() {
        return ValutatoreStato.valutaStato(this);
    }
    ...
    public String toString() {
        ...
        sb.append("Number of double morrises player (B): " + this.numberOfDoubleMorrises(PLAYER_B) + "\n");
        ...
        sb.append("Number of 2 pieces configurations player (W): " + this.numberOf2PiecesConfiguration(PLAYER_W) + "\n");
        ...
        sb.append("Number of 3 pieces configurations player (B): " + this.numberOf3PiecesConfiguration(PLAYER_B) + "\n");
        ...
        sb.append("Number of reachable positions player (W): " + this.numberOfReachablePositions(PLAYER_W) + "\n");
        ...
        sb.append("Number of unblockable morrises player (B): " + this.numberOfUnblockableMorrises(PLAYER_B) + "\n");
        ...
        */
        ...
        for (Mossa move : this.movesHistory) {
