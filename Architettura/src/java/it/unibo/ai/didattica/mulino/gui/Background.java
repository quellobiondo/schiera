...
public class Background extends JFrame {
	...
	public Background() {
		super();
		try{
			InputStream input = getClass().getClassLoader().getResourceAsStream("board.jpg");
			background = ImageIO.read(input);
			input = getClass().getClassLoader().getResourceAsStream("white.png");
			white = ImageIO.read(input);
            input = getClass().getClassLoader().getResourceAsStream("black.png");
